package com.crow.alloyed_deco.blocks;
...
public class BronzeSheetSet {
    ...
    public BronzeSheetSet(AbstractRegistrate<?> registrate, String name, String endTextureName, Variant<?>[] variants) {
        this(registrate, name, endTextureName, variants, NonNullBiConsumer.noop(), "copper/");
    }

    public BronzeSheetSet(AbstractRegistrate<?> registrate, String name, String endTextureName, Variant<?>[] variants, String generalDirectory) {
        this(registrate, name, endTextureName, variants, NonNullBiConsumer.noop(), generalDirectory);
    }

    public BronzeSheetSet(AbstractRegistrate<?> registrate, String name, String endTextureName, Variant<?>[] variants, NonNullBiConsumer<DataGenContext<Block, ?>, RegistrateRecipeProvider> mainBlockRecipe) {
    ...
    protected <T extends Block> BlockEntry<?> createEntry(AbstractRegistrate<?> registrate, Variant<T> variant,
        ...
        BlockBuilder<T, ?> builder = registrate.block(name, variant.getFactory(this, state, waxed))
                ...
                .simpleItem()
                .properties(props-> props.strength(5)
    ...
    public interface Variant<T extends Block> {
        ...
        NonNullFunction<Properties, T> getFactory(BronzeSheetSet blocks, WeatherState state, boolean waxed);

        default void generateLootTable(RegistrateBlockLootTables lootTable, T block, BronzeSheetSet blocks,
                                       WeatherState state, boolean waxed) {
        ...
        void generateBlockState(DataGenContext<Block, T> ctx, RegistrateBlockstateProvider prov, BronzeSheetSet blocks,
                                WeatherState state, boolean waxed);
    }
    ...
    public static class BlockVariant implements Variant<Block> {
        ...
        @Override
        public NonNullFunction<Properties, Block> getFactory(BronzeSheetSet blocks, WeatherState state, boolean waxed) {
            if (waxed) {
                return Block::new;
            } else {
        ...
        public void generateBlockState(DataGenContext<Block, Block> ctx, RegistrateBlockstateProvider prov,
                                       BronzeSheetSet blocks, WeatherState state, boolean waxed) {
            Block block = ctx.get();
    ...
    public static class SlabVariant implements Variant<SlabBlock> {
        ...
        @Override
        public NonNullFunction<Properties, SlabBlock> getFactory(BronzeSheetSet blocks, WeatherState state,
                                                                 boolean waxed) {
            if (waxed) {
        ...
        @Override
        public void generateLootTable(RegistrateBlockLootTables lootTable, SlabBlock block, BronzeSheetSet blocks,
                                      WeatherState state, boolean waxed) {
    ...
    public static class StairVariant implements Variant<StairBlock> {
        ...
        @Override
        public NonNullFunction<Properties, StairBlock> getFactory(BronzeSheetSet blocks, WeatherState state,
                                                                  boolean waxed) {
